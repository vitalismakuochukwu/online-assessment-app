        ...
        <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@onlineassess.com</p>
                    <p className="text-gray-600">sales@onlineassess.com</p>
                  </div>
                </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <button 
                type="submit" 
                className="w-full bg-blue-600 text-white font-bold py-4 rounded-lg hover:bg-blue-700 transition transform hover:scale-[1.02] shadow-md"
              >
                Send Message
              </button>
            </form>
